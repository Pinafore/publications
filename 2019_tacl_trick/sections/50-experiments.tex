...
For both \challenge{} and original test questions, early
...
frequently occur, accuracy on original test questions rises
 quicker than the \challenge{} ones. For both,
