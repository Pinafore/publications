...
\begin{figure}
\begin{overprint}
\centerline{\includegraphics[width=\textwidth]{methods_wiki.pdf}}
\end{overprint}
\end{figure}
\end{frame}
...
\begin{figure}
\begin{overprint}
\onslide<1> \centerline{\includegraphics[width=\textwidth]{user1.pdf}}
\onslide<2> \centerline{\includegraphics[width=\textwidth]{user2.pdf}}
\onslide<3-> \centerline{\includegraphics[width=\textwidth]{user3.pdf}}
\end{overprint}
\end{figure}
\end{frame}
