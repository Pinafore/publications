...
\begin{figure}[t]
  ...
  \caption{Proportion of refinement usage that is followed by undo. \textbf{Delete topic}~(10\%) and \textbf{split topic}~(8\%) are undone the most often. \textbf{Create topic} was never undone.}
  \label{fig:undo-norm}
\end{figure}
