...
%\renewcommand{\tabcolsep}{4pt} \begin{table*}[ht] \begin{center} \begin{tabular}{llccccccccc}
%\toprule & & \multicolumn{3}{c}{\abr{muc}} & \multicolumn{3}{c}{\abr{bcub}} &
%\multicolumn{3}{c}{\abr{ceafe}} \\ \cmidrule(r){3-5} \cmidrule(r){6-8}
%\cmidrule(r){9-11} Model & Mentions & P & R & F1 & P & R & F1 & P & R & F1
%\\ \midrule QB Final & Berkeley & 60.2 & 33.4 & 42.4 & 56.9 & 21.1 & 30.7 &
%56.9 & 13.0 & 21.2 \\ \midrule QB Final & CRF & 56.9 & 29.6 & 38.9 & 50.6 &
%18.7 & 27.2 & 51.7 & 12.7 & 20.4 \\ LR & CRF & 67.0 & \bf 72.4 & \bf 67.8 &
%59.2 & \bf 78.6 & 63.9 & 58.7 & 48.6 & 49.2 \\ \midrule QB Final & Gold & \bf
%70.2 & 40.2 & 49.6 & \bf 88.5 & 64.7 & \bf 74.2 & 56.5 & \bf 80.0 & 65.7 \\ LR
%& Gold & 58.8 & 56.8 & 57.8 & 68.1 & 74.8 & 70.4 & \bf 73.3 & 76.1 & \bf 74.2
%\\ \bottomrule \end{tabular} \end{center} \caption{Comparison of the \abr{lr}
%pairwise classifier to the Berkeley \emph{QB Final} system. All models are
%trained and evaluated on quiz bowl data. The evaluation is done by a five fold
%cross validation. The first row depicts the performance of Berkeley system
%using its own mention detection and its QB Final model on our dataset. The
%second and third row both use detected \abr{crf} mentions, comparing the
%Berkeley Final model to our \abr{lr} model. The last two rows use the gold
%mentions, i.e. the hand-tagged mentions and compare the performance of the two
%systems. Our model outperforms the Berkeley model on every metric when using
%our detected \abr{crf} mentions. When we give both systems the gold mentions,
%\abr{lr} outperforms Berkeley \emph{QB Final} in five of nine metrics. The
%bolded values are the highest in every column.}  \label{tab:our} \end{table*}
