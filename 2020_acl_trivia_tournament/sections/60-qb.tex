...
However, given then community's emphasis on fair evaluation, there are likely \emph{aspects} that computer \abr{qa} can borrow from the gold standard of human \abr{qa}.
